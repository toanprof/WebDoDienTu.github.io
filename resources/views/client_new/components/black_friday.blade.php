<section class="bg-white">
    <div class="container">
                            ...
                            <div class="card-image">
                                <a href="/product/{{$value->id}}">
                                    <img src="{{ $value->hinh_anh }}"
                                        ...
                                        data-img="{{ $value->hinh_anh }}"
                                        data-img-hover="{{ $value->hinh_anh }}"
                                        alt="...">
                                </a>
                            </div>
                                    ...
                                    <div>
                                        <h2 class="card-title mb-1 h5">
                                            <a href="/product/{{$value->id}}" class="text-dark">
                                                {{ strlen($value->ten_san_pham) < 30 ? $value->ten_san_pham : Str::substr($value->ten_san_pham, 0, 30) . '...' }}
                                            </a>
                                        </h2>
        ...
        <div class="text-right pt-4">
            <a href="/category/{{$sanPhamMoi[0]->danh_muc_id}}" class="link link-main link-dark">View collection</a>
        </div>
