                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-simple" method="post" action="/register" novalidate>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left mb-1">
                                                <input name="full_name" placeholder="Nhập vào họ và tên" type="text" class="form-control form-control-lg">
                                                <div class="form-control-position">
                                                    <i class="feather icon-user"></i>
                                                </div>
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left mb-1">
                                                <input name="email" placeholder="Nhập vào email" type="email" class="form-control form-control-lg">
                                                <div class="form-control-position">
                                                    <i class="feather icon-user"></i>
                                                </div>
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left mb-1">
                                                <input name="phone" placeholder="Nhập vào số điện thoại" type="phone" class="form-control form-control-lg">
                                                <div class="form-control-position">
                                                    <i class="feather icon-user"></i>
                                                </div>
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left mb-1">
                                                <input name="password" placeholder="Nhập vào mật khẩu" type="password" class="form-control form-control-lg">
                                                <div class="form-control-position">
                                                    <i class="feather icon-user"></i>
                                                </div>
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left mb-1">
                                                <input name="re-password" placeholder="Nhập lại mật khẩu" type="password" class="form-control form-control-lg">
                                                <div class="form-control-position">
                                                    <i class="feather icon-user"></i>
                                                </div>
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left mb-1">
                                                <input name="address" placeholder="Nhập vào địa chỉ" type="text" class="form-control form-control-lg">
                                                <div class="form-control-position">
                                                    <i class="feather icon-user"></i>
                                                </div>
                                            </fieldset>
                                            <fieldset class="form-group position-relative has-icon-left mb-1">
                                                <input name="birthday" placeholder="Chọn ngày sinh" type="date" class="form-control form-control-lg">
                                                <div class="form-control-position">
                                                    <i class="feather icon-user"></i>
                                                </div>
                                            </fieldset>
